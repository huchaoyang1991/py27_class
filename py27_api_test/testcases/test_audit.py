...
class AuditTestCase(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # admin_id
        cls.admin_member_id, cls.admin_user_token = cls.common.login(conf.get("test_data", "admin_phone"),
    ...
    def test_audit(self, case):
        ...
        response = requests.post(url=url, method=method, json=data, headers=headers)
        res = response.json()
        # 断言
        try:
